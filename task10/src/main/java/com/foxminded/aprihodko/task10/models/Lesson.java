...
public class Lesson extends LongEntity implements Serializable {
	...
	@NotNull(message = "Spend time cannot be empty.")
	@Min(1)
	@Max(999)
	...
	public Lesson(Long id, DayOfWeek dayOfWeek, int timeSpan, Long roomId, Long groupId, Long courseId, Long teacherId) {
		this.id = id;
	...
	public String toString() {
		return "Lesson [dayOfWeek=" + dayOfWeek + ", timeSpan=" + timeSpan + ", roomId=" + roomId + ", groupId=" + groupId
				+ ", courseId=" + courseId + ", teacherId=" + teacherId + ", id=" + id + "]";
	}
